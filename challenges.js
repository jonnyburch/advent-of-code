  ...
  numbers.forEach(element => {
    numbers.forEach(add1 => {
      numbers.forEach(add2 => {
        if (element + add1 + add2 == 2020) {
          console.log(element * add1 * add2);
        }
      })
    })
  });
...
function challenge3() {
  ...
  passwords.forEach(password => {
    ...
    var lower = pwArray[0].split("-")[0]
    var higher = pwArray[0].split("-")[1]
    var letter = pwArray[1]
    var string = pwArray[2]
    if (isItValid(lower, higher, letter, string) == true) {
      validPasswords++
    }
  });
  console.log(validPasswords)

  function isItValid(lower, higher, letter, string) {
    var count = 0
...
function challenge4() {
  ...
  passwords.forEach(password => {
    pwArray = password.split(" ")
    var firstPosition = pwArray[0].split("-")[0]
    var secondPosition = pwArray[0].split("-")[1]
    var letter = pwArray[1]
    var string = pwArray[2]
    if (isItValid(firstPosition, secondPosition, letter, string) == true) {
      validPasswords++
    }
  });
  console.log(validPasswords)

  function isItValid(firstPosition, secondPosition, letter, string) {
    if (letter == string.charAt(firstPosition - 1) && letter != string.charAt(secondPosition - 1)) {
      return true;
    } else if (letter != string.charAt(firstPosition - 1) && letter == string.charAt(secondPosition - 1)) {
      return true;
    } else {
      return false;
    }
